...
/*   Updated: 2026/01/08 01:33:45 by faeljedd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static t_list	*biggest_node (t_list **lst)
{
	t_list	*node;
	t_list	*tmp;
	size_t	index;
